...
for event in longpoll.listen():
    if event.type == VkBotEventType.MESSAGE_NEW:
        ...
        if game.move == 'start':
            ...
            m1 = 'Каждый ход вам будет прибавляться доход и будут происходить события на которые вы сможете совершать разные действия, которые повлияют на сюжет'
            m2 = '(вместо написания ответов вручную вы можете воспользоваться кнопками)'
